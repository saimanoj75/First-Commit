...
const IndexPage = () => (
  <div>
    ...
    <h3>Step 1</h3>
    <p>
      Goto the <a target="_blank" href="https://github.com/saimanoj75/First-Commit"> GitHub repository </a> of this project and fork the project to your account. <i className="em em-knife_fork_plate"></i>  
      ...
      <Code code="https://github.com/saimanoj75/First-Commit"/>
    </p>
    <h3>Step 2</h3>
    <p>
    ...
    <p>
      ...
      It should look like <b>YOUR_USER_NAME.md</b> <i>eg: saimanoj75.md </i><br/>
    ...
    <h3>Step 7</h3>
    <p>
      Now, open your web browser and goto the <a target="_blank" href="https://github.com/saimanoj75/First-Commit"> original repository on GitHub</a>. If your changes has been pushed to your forked copy, You'll be able to see an option saying "New Pull Request" in the original repository.
